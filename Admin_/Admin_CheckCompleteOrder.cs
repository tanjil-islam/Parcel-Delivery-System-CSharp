...
{
    public partial class Admin_CheckCompleteOrder : Form
    {
        ...
        public Admin_CheckCompleteOrder(Panel mainpanel,string name)
        {
            InitializeComponent();
        ...
        private void label1_Click(object sender, EventArgs e)
        {
            try
            {
                string query = "SELECT COUNT(*) FROM CompleteOrdersInfo ";
        ...
        private void Admin_CheckCompleteOrder_Load(object sender,EventArgs e)
        {
            try
            {
        ...
        private void txtSearchPerson_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlDataAdapter sda = new SqlDataAdapter("Select * from CompleteOrdersInfo where (Cust_Name like '%" + txtSearchPerson.Text + "%' " +
