...
namespace Parcel_Delivery_Management_System
{
    public partial class AdminCreateAccount : Form
    {
        ...
        private void btnRegister_Click(object sender, EventArgs e)
        {
            ...
            {
                Admin admin = new Admin(userName, userEmail, userPassword, userAddress, userPhoneNo, userAppartmentNo, userPostalCode, userStreetAddress, userCity);

                bool registrationSuccess = admin.Register();
